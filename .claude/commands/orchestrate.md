...
Contract: read `~/git/mb-orchestration/AGENTS.md`; when routing review, `~/git/mb-orchestration/DOCTRINE.md` §Review depth (the single-source class map — do not re-summarize it). Domain files (load by domain, under `~/git/mb-orchestration/`): `mcp-routing.md` · `sol-usage.md` · `cursor-usage.md` · `fireworks-usage.md` · `usage-metering.md` · `visual-qa.md` · `grokbot-connection.md` · `analytics-clarity.md` · `EDGE-CASES.md`.
