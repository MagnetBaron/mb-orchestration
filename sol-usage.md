...
| Sol | Git-diff review — the OpenAI-family gate (second in the order after Opus 5), and the cross-family second pass |
...
2. Opus 5 already used on this change-set, or cross-family needs the OpenAI family (or owner said Sol)?
